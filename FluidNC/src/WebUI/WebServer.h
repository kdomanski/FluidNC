...
#    endif
    ...
    private:
        ...
        static String getContentType(const FluidPath &path);
...
#    endif
        ...
        static bool streamFile(const String &path, bool download = false);
        static bool streamFile(const FluidPath &path, bool download = false);
